...
def convert_examples_to_features(examples, seq_length, tokenizer):
    # print(BertTokenizer.pretrained_vocab_files_map.keys())
...
class SER_Full():
    ...
    def __getitem__(self, index):
        ...
        return img, target, np.array(word_id, dtype=int), np.array(word_mask, dtype=int), np.array(topic_id, dtype=int), np.array(topic_mask, dtype=int)#, imgname
